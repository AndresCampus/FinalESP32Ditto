...
5. Haz clic en el botón **Deploy** (Arriba a la derecha) para subirlo a tu propio servidor y luego dirígete a la URl terminada en dashboard (ej. `micro1.iot-uma.es/dashboard`) para navegar por tu nuevo panel interactivo vacío.
